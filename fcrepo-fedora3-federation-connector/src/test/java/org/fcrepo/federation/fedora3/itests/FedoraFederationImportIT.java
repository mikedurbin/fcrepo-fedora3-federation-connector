...
@ContextConfiguration({"/spring-test/copy-test.xml"})
public class FedoraFederationImportIT {

    @Autowired
    Repository repo;

    private static final Logger logger = getLogger(FedoraFederationImportIT.class);
    ...
    public void testFederationObject() throws LoginException, RepositoryException {
        ...
        session.getWorkspace().copy("/f3/" + ID.objectID("fedora-system:ContentModel-3.0").getId(), "/copy");
